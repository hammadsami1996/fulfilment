...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('orders', function (Blueprint $table) {
            ...
            $table->decimal('payment_status',10,2)->nullable();
            ...
            $table->decimal('qunatity',10,2)->nullable();
            ...
            $table->decimal('coupons_discount')->nullable();
            ...
            $table->decimal('replacement_qty',10,2)->nullable();
