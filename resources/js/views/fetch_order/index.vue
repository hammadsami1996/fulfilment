      ...
      <div class="card-container mb-6"  >
          ...
          <div class="flex-auto flex flex-row sm:flex-nowrap sm:items-center"  v-for="data in store">
                ...
                <button
                  ...
                  @click="woocommerce_fetch_data(data.id)"  :disabled="loadingWoo"
                ...
                >
                  Fetch
                  <svg
                    aria-hidden="true" v-if="loadingWoo"
                    role="status"
                ...
                >
                  ...
                  <div v-if="data.plate_form == 'Shopify'">
                      ...
                      <div>
            <button
              v-if="activePlatform === data.id " :disabled="loadingshop"
              @click="shopify_fetch_data(data.id)"
              class="bg-blue-400 hover:bg-blue-600 inline-flex justify-center items-center space-x-2 border font-semibold rounded-lg px-2 py-2 leading-5 text-sm border-gray-200 text-white"
            >
              Fetch
              <svg v-if="loadingshop"
                aria-hidden="true"
                role="status"
                class="inline w-4 h-4 mr-3 ml-3 text-white animate-spin"
                viewBox="0 0 100 101"
            ...
            >
              ...
              >
                ...
                />
                  ...
                  <div>
            <button
              v-if="activePlatform === data.id" :disabled="loadingmim"
              @click="mimcart_fetch_data(data.id)"
              class="bg-blue-400 hover:bg-blue-600 inline-flex justify-center items-center space-x-2 border font-semibold rounded-lg px-2 py-2 leading-5 text-sm border-gray-200 text-white"
            >
              Fetch
              <svg  v-if="loadingmim"
