                ...
                <div v-if="data.plate_form == 'WooCommerce'">
                    ...
                    <div>
                        <button
                            ...
                            v-if="activePlatform === data.id && !loading"
                        >
                            Fetch
                        </button>
    ...
    export default {
        ...
        methods: {
            ...
            async woocommerce_fetch_data(id) {
                this.loading = true; // Set loading state to true when the fetch starts
                try {
                    ...
                    this.loading = false; // Ensure loading is set back to false even if there is an error
                }
            },
