...
<script>
    ...
    function initialize(to) {
        let urls = {
            add: `/api/job_speciality/create`,
            edit: `/api/job_speciality/${to.params.id}/edit`,
        }
    ...
    export default {
        ...
        data() {
            return {
                error: {},
                show: false,
                resource: '/job_speciality',
                store: '/api/job_speciality',
                method: 'POST',
                small: 'job_speciality',
                capital: 'Job Speciality',
                title: 'Add',
                message: 'New job_speciality Added',
                permissions: {},
            }
        },
