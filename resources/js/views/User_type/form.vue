        ...
        <div class="p-6">
            ...
            <div class="flex-auto flex flex-col sm:flex-row sm:items-center">
                <div class="w-full sm:w-1/2 mb-4 sm:mb-0 p-2">
                    ...
                    />
                    <p class="text-red-600 text-xs italic" v-if="error.user_type">{{ error.user_type[0] }}</p>
                </div>
            </div>
...
<script>
    ...
    function initialize(to) {
        let urls = {
            add: `/api/user_type/create`,
            edit: `/api/user_type/${to.params.id}/edit`,
        }
