    ...
    export default {
        ...
        data() {
            return {
                ...
                capital: "Jobs",
                columns: [
                    {label: 'S.No', field: 'S.No', format: 'index'},
                    {label: 'Name', field: 'name',},
                    {label: 'Location', field: 'name', displayText: 'location'},
                    {label: 'Job Role', field: 'name', displayText: 'role'},
                    {label: 'Job Type', field: 'name', displayText: 'type'},
