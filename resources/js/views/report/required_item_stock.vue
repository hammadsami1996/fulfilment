    ...
    <div>
        ...
        <div class="flex-row">
            ...
            <div class="flex flex-row">
                <div class=" flex-col-6 ml-6 mt-4" colspan="8">
                    <button
                        ...
                        type="button">
                        <svg height="1.5em" style="margin-right: 10px;" viewBox="0 0 512 512"
            ...
            <panel :columns="columns" :urlApi="urlApi" id="print" ref="TableData">
                ...
                <template v-slot:action="props">
                    <div class="text-sm font-medium flex">
                        <input :checked="download.includes(props.item.product_id)" @click="isChecked(props.item, props.item.product_id)"
        ...
        >
            ...
            <div>
                <div class="col-12 ">
                    <div
                        style=" max-width: 70%; height: 100%; justify-content: center; align-items: center; margin-left: 15%; ">
