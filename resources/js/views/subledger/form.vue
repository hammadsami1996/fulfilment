        ...
        <div class="p-6">
            ...
            <div class="flex-auto flex flex-col sm:flex-row sm:items-center">
                <div class="w-full sm:w-1/2 mb-4 sm:mb-0 p-2">
                    ...
                    >Subledger Title <span class="text-red-600">*</span></label>
                    <input
                        class="w-full py-2 px-3 bg-white h-8 border border-gray-300 rounded-md"
                        type="text"
                        v-model="form.subledger_title"
                    />
...
<script>
    ...
    function initialize(to) {
        let urls = {
            add: `/api/subledger/create`,
            edit: `/api/subledger/${to.params.id}/edit`,
        }
    ...
    export default {
        ...
        methods: {
            ...
            successfully(res) {
                this.$emit('cancel-subledger', {

                })
            },
            formSubmiting() {
                this.$emit('save-subledger', {})
            },
        },
    }
</script>
