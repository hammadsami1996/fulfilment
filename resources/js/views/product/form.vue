        ...
        <div class="w-8/12 mx-2">
            <div class="bg-white shadow-md rounded-lg p-6">
                ...
                <div class="col-span-12 mt-6">
                    <div class="mb-4">
                        <label class="block font-medium text-gray-700">Short Description</label>
                        <div id="description">
                ...
                <button @click='toggle = !toggle'
                        class="font-semibold bg-indigo-500 hover:bg-indigo-600 text-white py-2 px-4 rounded-md"
                        type="button">Show More Description
                </button>
                    ...
                    <div class="col-span-12 mt-6">
                        ...
                        <div class="mb-4">
                            <div id="specification">
                                <vue-editor v-model="form.specification"></vue-editor>
                            </div>
                        </div>
                    </div>
                    <div class="col-span-12 mt-6">
            ...
            <div class="bg-white shadow rounded-lg mt-6">
                <div class="p-4">
                    <h3 class="text-xl font-semibold mb-2">Image Gallery<span @click="CopyToAll" class="cursor-pointer text-blue-500 text-sm">(copy to all)</span></h3>
                    <div class="mt-4">
                        <label class="block text-sm font-medium text-gray-700">Image:</label>
                        <div class="mt-2">
                            <!-- For mode !== 'edit' -->
                            <upload-media @media="Media" @ready="upload" v-if="mode !== 'edit'" class="w-full" />

                            <!-- For mode === 'edit' -->
                            <update-media :media_file_path="media_file_path" :media_server="media_server" @added-media="AddedMedia" @deleted-media="deletedMedia" @ready="upload" @saved-media="savedMedia" v-if="mode === 'edit'" class="w-full" />
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                        ...
                        <div class="form-group">
                            ...
                            <div class="flex items-center mt-2">
                                <label
                                    for="meta_image_input"
                                    class="cursor-pointer flex items-center justify-center w-12 h-8 bg-gray-200 border border-gray-300 rounded-lg hover:bg-gray-300 focus:ring focus:border-indigo-500 transition-all duration-200"
                                >
                                    <svg
                                        ...
                                        xmlns="http://www.w3.org/2000/svg"
                                    >
                                        <!-- Add an icon for the file upload -->
                                    </svg>
                                </label>
                                <input
                                    id="meta_image_input"
                                    type="file"
                                    v-on:change="onMetaImageChange"
                                    class="hidden"
                                />
                                <img
                                    :src="MetaImgUrl"
                                    class="w-8 h-8 ml-2 rounded-lg"
                                    v-if="MetaImgUrl"
                                    alt="Meta Image"
                                />
                            </div>
...
<!--                    </div>-->
        ...
        <div class="w-4/12  mx-4">
            <div class="col-span-12">
                <div class="bg-white shadow-md rounded-lg p-6">
                    <h3 class="text-xl font-bold mb-4">Price & Stock</h3>
                    <form class="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-2">
                        <div>
                        ...
                        <div>
                            ...
                            <input
                                class="w-full py-1 px-2 text-sm bg-gray-100 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500"
                                type="number" v-model="form.discounted">
                        </div>
                        <div>
                        ...
                        <div class="col-span-1 flex items-center">
                            <!--                            <label class="text-sm font-medium text-gray-700">Show Timer</label>-->
                        ...
                        <div class="col-span-2 flex items-center">
                            <!--                            <label class="font-medium text-gray-700">Free Shipping</label>-->
                            <label class="checkbox-inline ml-2">
            ...
            <div class="w-full">
                <div class="card-block mt-4 p-4 rounded-lg shadow-lg bg-white">
                    <h3 class="mb-4 text-xl font-semibold">Product Organization</h3>
...
<!--                    </div>-->
            ...
            <div class="w-full">
                <div class="card-block mt-4 p-4 rounded-lg shadow-lg bg-white">
                    <h3 class="mb-4 text-xl font-semibold">Service & Delivery</h3>
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-700">Return Note</label>
                        <div class="relative">
                            <typeahead
                                :initialize="form.category"
                                :url="categorys"
                    ...
                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-700">Merchant(s)</label>
                        <div class="relative">
                            <select
                                class="form-select mt-1 block w-full bg-white border border-gray-300 rounded-md shadow-sm focus:ring focus:ring-indigo-300 focus:outline-none text-gray-700"
                            >
                                <option value="select">--select--</option>
                                <option value="mimsoft">mimsoft</option>
                                <option value="mimsoft">bawasoft</option>
                            </select>
                        </div>
                    </div>
