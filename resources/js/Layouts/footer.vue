    ...
    <footer id="page-footer" class="flex flex-none items-center bg-white">
      <div class="text-center flex flex-col md:text-left md:flex-row md:justify-between text-sm max-w-10xl mx-auto px-4 lg:px-8 w-full">
        <div class="pt-4 pb-1 md:pb-4">
          <a href="https://tailkit.com" target="_blank" class="font-medium text-primary-600 hover:text-primary-400">Mimsoft</a> ©
        </div>
...
<!--          <span>by <a href="https://pixelcave.com" target="_blank" class="font-medium text-primary-600 hover:text-primary-400">pixelcave</a></span>-->
<!--        </div>-->
      </div>
    </footer>
</template>
