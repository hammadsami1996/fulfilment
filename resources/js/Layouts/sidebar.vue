        ...
        <div
            ...
            <a class="group inline-flex items-center space-x-2 font-bold text-lg tracking-wide text-gray-900 hover:text-gray-600 dark:text-gray-100 dark:hover:text-gray-300"
               href="#">
                <svg
                    aria-hidden="true"
                    class="hi-mini hi-cube-transparent inline-block w-5 h-5 text-indigo-600 transition group-hover:scale-110 dark:text-indigo-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
