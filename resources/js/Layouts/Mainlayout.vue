...
<template>
    ...
    >
        <!-- Page Sidebar -->
        <Sidebar :mobileSidebarOpen="mobileSidebarOpen" :desktopSidebarOpen="desktopSidebarOpen" />
        <!-- Page Sidebar -->
    ...
    <!-- <button @click="showDropdown = !showDropdown">
      Toggle Dropdown
        ...
        <!-- Page Content -->
        <main id="page-content" class="flex flex-auto flex-col max-w-full pt-14">
            <!-- Page Section -->
            <div class="max-w-10xl mx-auto p-4 w-full">
