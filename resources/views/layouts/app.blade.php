...
{{--        <title>{{ config('app.name', 'MimHRMS') }}</title>--}}
...
{{--          <input type="text" class="w-full block border border-gray-200 rounded px-3 py-2 leading-5 text-sm focus:border-primary-500 focus:ring focus:ring-primary-500 focus:ring-opacity-50" id="search" name="search" placeholder="Search..">--}}
{{--        </form>--}}
{{--      </div>--}}
{{--      <div class="sm:hidden">--}}
...
{{--              <x-dropdown-link :href="route('profile.edit')" role="menuitem"  class="flex items-center space-x-2 rounded py-2 px-3 text-sm font-medium text-gray-600 hover:bg-gray-100 hover:text-gray-700 focus:outline-none focus:bg-gray-100 focus:text-gray-700">--}}
...
{{--                <span :href="route('profile.edit')">Profile</span>--}}
{{--              </x-dropdown-link>--}}
...
{{--                            this.closest('form').submit();" type="submit" role="menuitem" class="w-full text-left flex items-center space-x-2 rounded py-2 px-3 text-sm font-medium text-gray-600 hover:bg-gray-100 hover:text-gray-700 focus:outline-none focus:bg-gray-100 focus:text-gray-700">--}}
...
<head>
    ...
    <title>{{ config('app.name', 'fulfilment') }}</title>
    <!-- Favicons -->
...
<script type="text/javascript">
    window.apex = {
        user: {
            ...
            name: "{{auth()->user()->name}}",
            id: "{{auth()->user()->id}}",
            tenant: "{{DB::connection('mysql')->table('domains')->where(['domain'=>request()->getHost()])->exists()}}",
            {{--auth_guard: "{{auth()->user()->getGuarded()}}",--}}
            permissions:  @json(auth()->user()->getAllPermissions()),
            permission:  @json(auth()->user()->getAllPermissions()->pluck('name')),
        }
    };
</script>
</html>
